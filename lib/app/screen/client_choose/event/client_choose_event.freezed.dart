...
/// @nodoc
class _$ClientChooseEventTearOff {
  const _$ClientChooseEventTearOff();

  GetClients getClients({required String trainerId}) {
    return GetClients(
      trainerId: trainerId,
    );
  }
  ...
  InviteClient inviteClient() {
    return const InviteClient();
  }
}

/// @nodoc
const $ClientChooseEvent = _$ClientChooseEventTearOff();
...
abstract class GetClients implements ClientChooseEvent {
  const factory GetClients({required String trainerId}) = _$GetClients;

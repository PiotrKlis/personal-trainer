...
/// @nodoc
class _$VideoDataTearOff {
  const _$VideoDataTearOff();

  _VideoData call({required Data data}) {
    return _VideoData(
      data: data,
    );
  }

  VideoData fromJson(Map<String, Object?> json) {
    return VideoData.fromJson(json);
  }
}

/// @nodoc
const $VideoData = _$VideoDataTearOff();
...
abstract class _VideoData implements VideoData {
  const factory _VideoData({required Data data}) = _$_VideoData;
